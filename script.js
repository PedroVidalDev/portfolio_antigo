...
function html_tr(){
    document.getElementById("html_logo").src = "assets/images/icons/html_icons/html_logo.png";
...
function html(){
    document.getElementById("html_logo").src = "assets/images/icons/html_icons/html_logo_initial.png";
    document.getElementById("descricao_skill").innerHTML = "/*Coloque o mouse sobre a imagem<br>para ver sua devida descrição.*/";
}
function css_tr(){
    document.getElementById("css_logo").src = "assets/images/icons/css_icons/css_logo.png";
...
function css(){
    document.getElementById("css_logo").src = "assets/images/icons/css_icons/css_logo_initial.png";
    document.getElementById("descricao_skill").innerHTML = "/*Coloque o mouse sobre a imagem<br>para ver sua devida descrição.*/";
}

function js_tr(){
    document.getElementById("js_logo").src = "assets/images/icons/js_icons/js_logo.png";
...
function js(){
    document.getElementById("js_logo").src = "assets/images/icons/js_icons/js_logo_initial.png";
    document.getElementById("descricao_skill").innerHTML = "/*Coloque o mouse sobre a imagem<br>para ver sua devida descrição.*/";
}

function c_tr(){
    document.getElementById("c_logo").src = "assets/images/icons/c_icons/c_logo.png";
...
function c(){
    document.getElementById("c_logo").src = "assets/images/icons/c_icons/c_logo_initial.png";
    document.getElementById("descricao_skill").innerHTML = "/*Coloque o mouse sobre a imagem<br>para ver sua devida descrição.*/";
}

function py_tr(){
    document.getElementById("py_logo").src = "assets/images/icons/py_icons/py_logo.png";
...
function py(){
    document.getElementById("py_logo").src = "assets/images/icons/py_icons/py_logo_initial.png";
    document.getElementById("descricao_skill").innerHTML = "/*Coloque o mouse sobre a imagem</br>para ver sua devida descrição.*/";
}
...
function github_logo(){
    document.getElementById("github_logo").src = "assets/images/icons/github_icons/github_logo_tr.png";
}

function github_logo_out(){
    document.getElementById("github_logo").src = "assets/images/icons/github_icons/github_logo.png";
}
